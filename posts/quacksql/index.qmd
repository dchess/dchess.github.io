...
districts = db.district_math_averages(path="state_assessment.parquet")

growth = db.school_growth()
```
...
```python
db = quacksql.connect("education.duckdb")

enrollment = db.district_enrollment(
    enrollment_file="enrollment.parquet"
)

proficiency = db.proficiency_rate(

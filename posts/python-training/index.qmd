...
So we reached for [Google Colab](https://research.google.com/colaboratory/faq.html), which had the ease of Jupyter Notebooks but with an in-browser, cloud hosted environment, and was shareable like any other Google Doc. 

...
![Image Git Change Tracking Visualized](git_visualized.png)
...
![Image Feature Branch Workflow](git_workflow.png)
...
![Image Github PR button](pr_button.png)
...
![Image Github PR approval](approve_pr.png)

#### 8. Merge (or squash merge) into main branch


![Image Github merge approved changes dialog](merge_changes.png)
...
![Image Checkout Branch Diagram](new_branch.png)
...
## Pulling Changes from `main` to a Local Branch AKA Merging Locally
 ...
 ![Image Local Merge Diagram](merge_local.png)
